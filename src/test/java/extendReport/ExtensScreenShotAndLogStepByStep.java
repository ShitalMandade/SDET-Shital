...
import com.aventstack.extentreports.reporter.ExtentHtmlReporter;
	...
	public class ExtensScreenShotAndLogStepByStep {
	...
	public void setup()
	{
	reporter= new ExtentHtmlReporter(System.getProperty("user.dir")+"/sdet12ScrAndLogStepByStep/newreport.html");//imp
	...
	String path=ExtensScreenShotAndLogStepByStep .getscreenshot(result.getName());
	...
	String destfile= System.getProperty("user.dir")+"/Screenshotsdir/"+name+".png";
